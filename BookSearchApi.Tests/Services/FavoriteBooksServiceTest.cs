...
public class FavoriteBooksServiceTests : IDisposable
{
    ...
    private readonly FavoriteBooksService _service;
    ...
    public FavoriteBooksServiceTests()
    {
        ...
        _service = new FavoriteBooksService(_db, _openLibraryServiceMock.Object, _loggerMock.Object);
    }
    ...
    {
        var result = await _service.GetBooksForUserAsync(Guid.NewGuid(), CancellationToken.None);
    ...
    public async Task GetBooksForUserAsync_ReturnsEmptyList_WhenUserHasNoFavorites()
    {
        ...
        var result = await _service.GetBooksForUserAsync(user.Id, CancellationToken.None);
    ...
    {
        var result = await _service.AddAsync(Guid.NewGuid(), _testKeyWithWorks, CancellationToken.None);
    ...
    public async Task AddAsync_ReturnsFavoriteBook_WhenUserExists()
    {
        ...
        var result = await _service.AddAsync(user.Id, _testKeyWithWorks, CancellationToken.None);
    ...
    public async Task AddAsync_SavesBookToDatabase_WhenUserExists()
    {
        ...
        await _service.AddAsync(user.Id, _testKeyWithWorks, CancellationToken.None);
    ...
    {
        var result = await _service.RemoveAsync(Guid.NewGuid(), _testKeyWithWorks, CancellationToken.None);
    ...
    public async Task RemoveAsync_ReturnsTrue_WhenBookIsRemoved()
    {
        ...
        var result = await _service.RemoveAsync(user.Id, _testKeyWithWorks, CancellationToken.None);
    ...
    public async Task RemoveAsync_DeletesBookFromDatabase_WhenBookIsRemoved()
    {
        ...
        await _service.RemoveAsync(user.Id, _testKeyWithWorks, CancellationToken.None);
